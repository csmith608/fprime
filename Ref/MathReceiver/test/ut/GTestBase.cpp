...
namespace Ref {
  ...
  void MathReceiverGTestBase ::
    ...
    const
  {
    ASSERT_LT(__index, this->tlmHistory_MR_OPERATION->size())
      << "\n"
      << "  File:     " << __callSiteFileName << "\n"
      << "  Line:     " << __callSiteLineNumber << "\n"
    ...
    const TlmEntry_MR_OPERATION& e =
      this->tlmHistory_MR_OPERATION->at(__index);
    ASSERT_EQ(val, e.arg)
      << "\n"
      << "  File:     " << __callSiteFileName << "\n"
      << "  Line:     " << __callSiteLineNumber << "\n"
  ...
  void MathReceiverGTestBase ::
    ...
    const
  {
    ASSERT_LT(__index, this->tlmHistory_MR_FACTOR1S->size())
      << "\n"
      << "  File:     " << __callSiteFileName << "\n"
      << "  Line:     " << __callSiteLineNumber << "\n"
    ...
    const TlmEntry_MR_FACTOR1S& e =
      this->tlmHistory_MR_FACTOR1S->at(__index);
    ASSERT_EQ(val, e.arg)
      << "\n"
      << "  File:     " << __callSiteFileName << "\n"
      << "  Line:     " << __callSiteLineNumber << "\n"
  ...
  void MathReceiverGTestBase ::
    ...
    const
  {
    ASSERT_LT(__index, this->tlmHistory_MR_FACTOR1->size())
      << "\n"
      << "  File:     " << __callSiteFileName << "\n"
      << "  Line:     " << __callSiteLineNumber << "\n"
    ...
    const TlmEntry_MR_FACTOR1& e =
      this->tlmHistory_MR_FACTOR1->at(__index);
    ASSERT_EQ(val, e.arg)
      << "\n"
      << "  File:     " << __callSiteFileName << "\n"
      << "  Line:     " << __callSiteLineNumber << "\n"
  ...
  void MathReceiverGTestBase ::
    ...
    const
  {
    ASSERT_LT(__index, this->tlmHistory_MR_FACTOR2->size())
      << "\n"
      << "  File:     " << __callSiteFileName << "\n"
      << "  Line:     " << __callSiteLineNumber << "\n"
    ...
    const TlmEntry_MR_FACTOR2& e =
      this->tlmHistory_MR_FACTOR2->at(__index);
    ASSERT_EQ(val, e.arg)
      << "\n"
      << "  File:     " << __callSiteFileName << "\n"
      << "  Line:     " << __callSiteLineNumber << "\n"
  ...
  {
    ASSERT_GT(this->eventHistory_MR_SET_FACTOR1->size(), __index)
      << "\n"
      << "  File:     " << __callSiteFileName << "\n"
      << "  Line:     " << __callSiteLineNumber << "\n"
    ...
    const EventEntry_MR_SET_FACTOR1& e =
      this->eventHistory_MR_SET_FACTOR1->at(__index);
    ASSERT_EQ(val, e.val)
      << "\n"
      << "  File:     " << __callSiteFileName << "\n"
      << "  Line:     " << __callSiteLineNumber << "\n"
  ...
  {
    ASSERT_GT(this->eventHistory_MR_UPDATED_FACTOR2->size(), __index)
      << "\n"
      << "  File:     " << __callSiteFileName << "\n"
      << "  Line:     " << __callSiteLineNumber << "\n"
    ...
    const EventEntry_MR_UPDATED_FACTOR2& e =
      this->eventHistory_MR_UPDATED_FACTOR2->at(__index);
    ASSERT_EQ(val, e.val)
      << "\n"
      << "  File:     " << __callSiteFileName << "\n"
      << "  Line:     " << __callSiteLineNumber << "\n"
  ...
  {
    ASSERT_GT(this->eventHistory_MR_OPERATION_PERFORMED->size(), __index)
      << "\n"
      << "  File:     " << __callSiteFileName << "\n"
      << "  Line:     " << __callSiteLineNumber << "\n"
    ...
    const EventEntry_MR_OPERATION_PERFORMED& e =
      this->eventHistory_MR_OPERATION_PERFORMED->at(__index);
    ASSERT_EQ(val, e.val)
      << "\n"
      << "  File:     " << __callSiteFileName << "\n"
      << "  Line:     " << __callSiteLineNumber << "\n"
