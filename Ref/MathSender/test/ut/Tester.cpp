...
namespace Ref {
  ...
  testAddCommand(){
    ...
    //verify the expected event was only sent once
      ...
      //verify that the correct response to the command was sent
      ...
      //prepare for calling MathSend's result port by clearing the port and telemetry history
      ...
      //test checks for the expected telemetry and events
